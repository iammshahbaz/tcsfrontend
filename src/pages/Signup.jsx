...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://nice-bee-leg-warmers.cyclic.app/users/signup', {
                email: email,
                password: password
            });
            if (response) {
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Heading color="blue.400">Signup</Heading>
            ...
            <Box>
                ...
                <RouterLink to="/" style={{ color: "#319795" }}>
                    Login
                </RouterLink>
